...
# selector([2, 1, 3, 2, 5, 1, 2, 6, 2, 7, 1, 5, 6, 3, 2, 6, 2, 1, 2])
...
# dic = {"hot dog": 2, "hamburger": 3, "steak sandwich": 5,
#        "fries": 1, "cole slaw": 1, "soda": 2}
# cost = 0
...
# def leap(year):
#     isLeap = 'The year given is not a leap year'
#     if year % 4 == 0:
#         if year % 100 != 0:
#             isLeap = 'Leap Year!'
#             return isLeap
...
# newtest = Student('Timmy', 'Smith', 2025)
# newtest.printname()
# newtest.printstudent()
